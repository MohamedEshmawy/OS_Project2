...
from frontend.Views.Config_Memory_View import Config_Memory_View

class Main_Window_View(Gtk.Grid):
	def __init__(self):
	...
	def config_memory_dialog(self, widget):
		#self.dialog = Config_Memory_View(self.memory)
		#self.dialog.show_all()
		self.dialog_main_window = Gtk.Grid()	
		#dialog_main_window = self.dialog.get_content_area()	

		#setting the spacings of the grid
		self.dialog_main_window.set_column_homogeneous = True
		self.dialog_main_window.set_column_spacing(20)
		self.dialog_main_window.set_row_spacing(20)
		...
		self.dialog_main_window.attach(box_size, 0, 3, 1, 1)

		self.dialog_main_window.attach(self.add_hole_btn, 0, 5, 1, 1)
		self.dialog_main_window.attach(self.done_btn, 0, 6, 1, 1)

		self.dialog_main_window.attach(self.listbox, 4, 0, 15, 8)
		self.dialog_main_window.show_all()