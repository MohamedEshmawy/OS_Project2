...
class Add_Process_Dialog(Gtk.Dialog):
	def __init__(self,parent_view, memory):
		Gtk.Dialog.__init__(self, "Add Process", parent_view)
		...
		#setting up the 'Add Segment', 'Done' buttons
	...
	def on_done_clicked(self, widget):
		...
		self.memory.add_process(self.process)
		self.destroy()
